package com.logistics.api.base;


import android.util.Log;

import com.logistics.api.base.persistentcookiejar.ClearableCookieJar;
import com.logistics.api.base.persistentcookiejar.PersistentCookieJar;
import com.logistics.api.base.persistentcookiejar.cache.SetCookieCache;
import com.logistics.api.base.persistentcookiejar.persistence.SharedPrefsCookiePersistor;
import com.logistics.app.MyApp;
import com.logistics.utils.Constant;
import com.logistics.utils.LogUtil;
import com.logistics.utils.NetUtils;
import com.logistics.utils.SharedPreferencesHelper;
...
//                .addInterceptor(loggingInterceptor)//设置 Debug Log 模式
    ...
    Interceptor REWRITE_HEADER_CONTROL_INTERCEPTOR = chain -> {
        Request request = chain.request()
                ...
                .addHeader("token", Constant.getData("token"))
//                .addHeader("app_key","0AB4343B9E518743784A92FBD58C502B")
...
//                .addHeader("Cookie", "add cookies here")
    ...
    class LoggingInterceptor implements Interceptor {
        ...
        public Response intercept(Chain chain) throws IOException {
            ...
            String time= String.format("发送请求 %s on %s%n%s",
            ...
            ResponseBody responseBody = response.peekBody(1024 * 1024);
                LogUtil.e(TAG, String.format("接收响应: [%s] %n返回json:【%s】 %.1fms%n%s",
